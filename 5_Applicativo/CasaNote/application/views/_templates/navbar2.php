<nav class="navbar navbar-expand-lg bg-dark m-0" >
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link <?php if(str_ends_with($_SERVER['REQUEST_URI'],'/')){echo 'text-white';}else{echo'text-secondary';} ?>"  href="<?php echo URL ?>home/user">Profilo <span class="sr-only">(current)</span></a>
            </li>
        </ul>
